...
-- Alias addPanel pour compatibilité avec DialogueHUD
...
function hud.addPanel(id, opts)
  ...
  -- Appeler setPanel SANS image pour éviter erreur resource cache
  -- Le bg sera traité comme couleur de fond, pas comme image
